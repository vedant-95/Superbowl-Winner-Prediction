...
def scraper(nfl: object, offensive_category = 'null', defensive_category = 'null'):
    ...
    for iterator in range(54):
        #making soup
        url = 'http://www.nfl.com/stats/categorystats?archive=true&conference=null&role=' + nfl.tm_opp + '&offensiveStatisticCategory=' + offensive_category + '&defensiveStatisticCategory=' + defensive_category + '&season='+str(iterator+1966)+'&seasonType=REG&tabSeq=2&qualified=false&Submit=Go'
